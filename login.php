...
<div class="member" style="width: 730px; height: 721px"> 
	&nbsp;<table border="0" width="730" height="420">
		<tr>
			<td height="121" width="476">
			<form method="GET" action=session.php>
			
			<input type=text name=pre_page value="<?php echo $_SERVER['HTTP_REFERER'];?>">
			
				<b>User Name:</a> </b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type=text name="user_name" size="44"> 
			<p> 
			&nbsp;</p>
			<p> 
			<b>Password :</a></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type=text name="password" size="44"></p>
<p> 
			&nbsp;</p>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<p> 
			&nbsp;</td>
			<td height="141" width="248" rowspan="3">
